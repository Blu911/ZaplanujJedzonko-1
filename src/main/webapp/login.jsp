    ...
    <nav class="navbar navbar-expand-lg justify-content-around">
        ...
        <ul class="nav nounderline text-uppercase">
            <li class="nav-item ml-4">
                <a class="nav-link color-header" href="../resources/html/login.html">logowanie</a>
            </li>
            <li class="nav-item ml-4">
                <a class="nav-link color-header" href="../../resources/html/registration.html">rejestracja</a>
            </li>
            <li class="nav-item ml-4">
                <a class="nav-link" href="/#about">o aplikacji</a>
            </li>
            <li class="nav-item ml-4">
                <a class="nav-link disabled" href="../../resources/html/recipes.html">Przepisy</a>
            </li>
            <li class="nav-item ml-4">
